#!/usr/bin/env python3
"""One-purpose RunPod worker for the v14a7 clipping-threshold ablation."""
...
RUNNER = "v14a7_clip_ablation"
ENTRY = shared.REPO_ROOT / "Erratum" / "ardor_v14a7_clip_ablation.py"
OUTPUT = (
    ...
    try:
        ...
        completed = {
            **started,
            ...
            "result_path": str(OUTPUT / "v14a7_clip_ablation_decision.json"),
        }

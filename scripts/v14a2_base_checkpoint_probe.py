#!/usr/bin/env python3
"""Inspect the exact v13b base checkpoint used by v14a2 without materializing tensor payload."""
...
KEY = "Ardor/training/runs/sft_v13b_routing_stage_trainer_v10_27_guard4_heavy_four_guard_correlation_phrase_landing/checkpoints/best_model.pt"
...
def main() -> int:
    ...
    Path("v14a2_base_checkpoint_probe.json").write_text(

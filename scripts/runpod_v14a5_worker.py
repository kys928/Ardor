#!/usr/bin/env python3
"""One-purpose RunPod worker for the v14a5 signal-first u100 diagnostic."""
...
RUNNER = "v14a5_signal_first_u100"
ENTRY = shared.REPO_ROOT / "Erratum" / "ardor_v14a5_signal_first_trainer.py"
OUTPUT = (
    ...
    try:
        ...
        completed = {
            **started,
            ...
            "result_path": str(OUTPUT / "v14a5_signal_landing_decision.json"),
        }
